...
const wordCounterContainer = createElement("div", {
  className: "word_counter_container",
  id: "wordCounterContainer",
});
const wordCounter = createElement("div", {
  className: "word_counter",
  id: "wordCounter",
});

const studyUnitContainer = createElement("div", {
  className: "study_unit_container",
  id: "studyUnitContainer",
});
...
const pinyin = createElement("div", {
  className: "pinyin",
  id: "pinyin_",
  text: "rén",
});
const definitionContainer = createElement("div", {
...
const translation = createElement("p", {
  ...
  id: "translation",
  text: "Time flies so fast.",
});

const flipButtonContainer = createElement("div", {
  className: "flip_button_container",
  id: "flipButtonContainer",
});
...
const cardNavigationButtonContainerBack = createElement("div", {
  className: "card_navigation_button_container",
  id: "cardNavigationBackBtnContainer",
});
const cardNavigationBack = createElement("button", {
  className: "card_navigation_btn",
  id: "cardNavigationBack",
  text: "←",
});

const cardNavigationButtonContainerShuffle = createElement("div", {
  className: "card_navigation_button_container",
  id: "cardNavigationShuffleBtnContainer",
});
const cardNavigationShuffle = createElement("button", {
  className: "card_navigation_btn",
  id: "cardNavigationShuffle",
  text: "⇄",
});

const cardNavigationNextBtnContainer = createElement("div", {
  className: "card_navigation_button_container",
  id: "cardNavigationNextBtnContainer",
});
const cardNavigationNext = createElement("button", {
  className: "card_navigation_btn",
  id: "cardNavigationNext",
  text: "→",
});
...
async function main() {
  ...
  if (window.location.pathname === "/chinese-study-app/range2.html") {
